...
// 보이는 월드(휴대폰 가로 화면 588×270)다. src/sim/constants.ts의 VIEW_WIDTH와 같다.
const vec2 WORLD_SIZE = vec2(588.0, 270.0);
...
const vec3 PALETTE[119] = vec3[119](
  ...
  vec3(0.5608, 0.1647, 0.3647),
  vec3(0.6627, 0.0000, 0.9725),
  vec3(0.8902, 0.0000, 0.3922),
  vec3(0.4706, 0.2627, 0.1412),
  vec3(0.0039, 0.4980, 0.2314),
  ...
  vec3(0.6588, 0.8157, 0.9961),
  vec3(0.9294, 0.8745, 0.0000),
  vec3(0.5216, 0.9255, 0.8667),
  vec3(1.0000, 0.7176, 0.6941),
  vec3(0.3725, 1.0000, 1.0000),
  vec3(0.9961, 0.8000, 0.4706),
